...
<s:div cssClass="superCapsalera">
    <s:div cssClass="capsalera">
                ...
                <s:form action="logout" method="post">
                 	...
                 	<s:url id="localeCA" namespace="/" action="mostrarCurs.action" >
   							<s:param name="request_locale" >ca</s:param>
   							<s:param name="id" ><s:property value="id"/></s:param>
						</s:url>
						<s:url id="localeES" namespace="/" action="mostrarCurs.action" >
   							<s:param name="request_locale" >es</s:param>
   							<s:param name="id" ><s:property value="id"/></s:param>
						</s:url>
						<s:url id="localeEN" namespace="/" action="mostrarCurs.action" >
    ...
    <s:div cssClass="contingut" cssStyle="margin-top:15%">
        ...
        <fieldset>
        	<h2><b><s:property value="titol"/></b>(<s:property value="idiomaSele"/>)</h2>
        </fieldset>
        <fieldset>
        ...
        <fieldset>
        	<s:if test="#session.usuari.nomUsuari == 'admin'">
    			<a class="lin" href="mostrarEditarCurs.action?id=<s:property value="id"/>" ><s:text name="curs.editarCurs" /></a>
    			<a class="lin" href="borrarCurs.action?id=<s:property value="id"/>" ><s:text name="curs.eliminarCurs" /></a>
    		</s:if>
    		<s:elseif test="#session.usuari.nomUsuari == usuari">
    			<a class="lin" href="mostrarEditarCurs.action?id=<s:property value="id"/>" ><s:text name="curs.editarCurs" /></a>
    			<a class="lin" href="borrarCurs.action?id=<s:property value="id"/>" ><s:text name="curs.eliminarCurs" /></a>
    		</s:elseif>
