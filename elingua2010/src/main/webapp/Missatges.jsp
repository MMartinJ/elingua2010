...
<s:div cssClass="superCapsalera">
    <s:div cssClass="capsalera">
                ...
                <s:form action="logout" method="post">
                 	...
                 	<s:url id="localeCA" namespace="/" action="llegirMissatge.action" >
   							<s:param name="request_locale" >ca</s:param>
   							<s:param name="nomUsuari" ><s:property value="usuaris.nomUsuari"/></s:param>
						</s:url>
						<s:url id="localeES" namespace="/" action="llegirMissatge.action" >
   							<s:param name="request_locale" >es</s:param>
   							<s:param name="nomUsuari" ><s:property value="usuaris.nomUsuari"/></s:param>
						</s:url>
						<s:url id="localeEN" namespace="/" action="llegirMissatge.action" >
    ...
    <s:div cssClass="contingut" cssStyle="margin-top:15%">
        <fieldset>
            <h2 class="subtitol"><s:text name="missatges.titol" /></h2>
			<s:div>
			<s:if test="destinatari!=''">
				 <p><b><s:text name="missatges.de" /></b> <s:property value="destinatari"/></p>
				<p><b><s:text name="missatges.assumpte" /></b><s:property  value="assumpte"/></p>
			</s:if>
			</s:div>
			<s:div cssClass="nota">
                      <s:property  value="missatge"/>
                           
            </s:div>  
			 
			<s:div>
			<s:if test="destinatari!=''">
				<s:if test="destinatari == 'admin'">
					<fieldset>
                       <a  href="mostrarEnviarMissatge.action?destinatari=<s:property value="destinatari"/>" class="lin" ><s:text name="missatges.enviarUnMissatge" /> <s:property value="destinatari"/></a>
                	</fieldset>
				</s:if>
				<s:else>
					<fieldset>
                       <a href="mostrarPerfilPublic.action?usuari=<s:property value="destinatari" />" class="lin" ><s:text name="missatges.anarAlPerfil" /> <s:property value="destinatari"/></a>&nbsp;<a  href="mostrarEnviarMissatge.action?destinatari=<s:property value="destinatari"/>" class="lin" ><s:text name="missatges.enviarUnMissatge" /> <s:property value="destinatari"/></a>
                	</fieldset>
				</s:else>
