...
<s:div cssClass="superCapsalera">
    <s:div cssClass="capsalera">
                ...
                <s:form action="logout" method="post">
                 	...
                 	<s:url id="localeCA" namespace="/" action="mostrarEstadistiques.action" >
   							<s:param name="request_locale" >ca</s:param>
   							
						</s:url>
						<s:url id="localeES" namespace="/" action="mostrarEstadistiques.action" >
   							<s:param name="request_locale" >es</s:param>
   							
						</s:url>
						<s:url id="localeEN" namespace="/" action="mostrarEstadistiques.action" >
    ...
    <s:div cssClass="contingut" cssStyle="margin-top:15%">
        <fieldset>
            <h2 class="subtitol"><s:text name="estadistiques.titol" /></h2>
			<s:div>
				<p><s:text name="estadistiques.dataRegistre" /> <s:property value="dataLogin" /></p>
				<p><s:text name="estadistiques.cursosCreats" /> <s:property value="cursosCreats" /></p>
				<p><s:text name="estadistiques.cursosConsultats" /> <s:property value="cursosVisitats" /></p>
				<p><s:text name="estadistiques.missatgesEnviats" /> <s:property value="missatgesEnviats" /></p>
				<p><s:text name="estadistiques.missatgesLlegits" /> <s:property value="missatgesLlegits" /></p>
            </s:div>      
       </fieldset>
    </s:div>
