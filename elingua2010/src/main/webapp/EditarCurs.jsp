...
<s:div cssClass="superCapsalera">
    ...
    <s:div cssClass="contingut" cssStyle="margin-top:15%">
        <fieldset>
		<h2><s:text name="editarCurs.titol" /></h2>
	
        
       <s:form id="formulari" dojoType="dijit.form.Form" method="post" commandName="bait" action="editarCurs">
       <s:fielderror />
	<s:div>
	<p>
	...
	<button type="submit" dojoType="dijit.form.Button" name="submitButton" style="color:#FFFFFF;font: bold 84% 'trebuchet ms',helvetica,sans-serif;background-color:#FF6633;border: 1px solid;border-color: #000000;"/><s:text name="editarCurs.editarCurs" /></button>
